...
**Pendentes (Épico 13):** **T-163** — o `render.yaml` declara 11 envs e o código lê ~34 (falta o `WEB_ORIGIN`: um deploy novo pelo blueprint sobe com CORS em `localhost`). **T-164** — `compararPlanos` não confere se as moedas dos dois planos batem.
