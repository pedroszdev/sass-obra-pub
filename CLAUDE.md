...
- Ainda mockadas: **Onboarding**, **Configurações** (aba Dados da empresa + Equipe & Plano → T-87/88), **Alertas** (T-90). _(Orçamentos: Épico 6; **Agenda**: T-91; **Notificações + Segurança** das Configurações: T-89.)_
