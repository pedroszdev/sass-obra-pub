...
- [ ] **T-125 — Refinar o classificador de obra + expandir captação (pregão/dispensa) — faseado** 🔴 *(follow-up da T-113)*
  ...
  - **Pronto quando:** a precisão medida numa amostra rotulada fica acima do limiar acordado, e a expansão está ligada **por fase** sem inundar a base de falsos-positivos.
