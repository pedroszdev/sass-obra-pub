...
- [~] **T-190 — Medidor de custo de IA** 🟠 — **T-190b (a tela) e T-190a (instrumentação `ai_usage`) FEITAS; falta a LEITURA por conta / hit rate.**
  ...
  - **⚠️ Falta (a leitura, entrega seguinte):** custo **por conta**, **hit rate** e os **contadores de resumos/diagnósticos por conta da T-184** — o `ai_usage` já grava o dado; falta consultá-lo e mostrá-lo. **"Alerta de teto diário por e-mail"** segue pendente (o circuit-breaker T-133 já BLOQUEIA no teto; falta só o aviso). O histórico começa **em 24/07/2026** — antes disso não há dado por conta, e não volta no tempo.
