...
- [~] **T-204 — Ligar o proxy Cloudflare (nuvem laranja)** 🔴 (infra) — **código entregue; medições de aceite FEITAS em 30/07; falta UM clique de painel (`SSL/TLS` → Full (strict)).**
